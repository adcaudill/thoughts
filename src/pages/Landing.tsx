        ...
        <div className="mx-auto max-w-6xl">
                ...
                <div className="max-w-3xl">
                    <div className="flex items-start gap-6">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-slate-600 lowercase dark:text-slate-300">a focused, markdown‑first, end-to-end encrypted notes app for writers and anyone who values privacy.</p>
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <article className="bg-white p-6 rounded-xl shadow-sm ring-1 ring-slate-100 dark:ring-slate-800/30">
                    ...
                    <p className="mt-2 text-slate-600 lowercase">organise ideas with folders, keep drafts together, and write in a clean, distraction-light markdown editor. autosave and cmd/ctrl+s keep your flow.</p>
                </article>
                <article className="bg-white p-6 rounded-xl shadow-sm ring-1 ring-slate-100 dark:ring-slate-800/30">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <article className="bg-white p-6 rounded-xl shadow-sm ring-1 ring-slate-100 dark:ring-slate-800/30">
                    ...
                    <ul className="mt-3 space-y-2 text-slate-700 text-sm">
                        ...
                        <li className="lowercase">set a word goal per folder and track progress — progress rings update automatically as you write.</li>
                        <li className="lowercase">a markdown editor — headings, lists, quotes, links, and code blocks; plain text, not an html wysiwyg.</li>
                        ...
                        <li className="lowercase">reading time & complexity estimates — optional in settings; detailed metrics (flesch, grade levels) live in note info.</li>
                        <li className="lowercase">focus tools: a full-page focus mode, plus an option to dim surrounding paragraphs while you type.</li>
                        <li className="lowercase">highlight potential style issues — filler words, redundancies, and common clichés are subtly marked (display-only).</li>
                    </ul>
                </article>
            </section>
            ...
            <section className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <article className="bg-white p-6 rounded-xl shadow-sm ring-1 ring-slate-100 dark:ring-slate-800/30">
                    ...
                    <p className="mt-2 text-slate-600 lowercase">only encrypted note blobs, nonces, and basic metadata (timestamps, folder ids, word counts). non-default folder names are encrypted on the client.</p>
                </article>
            </section>
